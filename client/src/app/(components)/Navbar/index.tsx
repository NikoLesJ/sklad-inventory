        ...
        <div className='flex justify-between items-center gap-5'>
            <div className='hidden md:flex justify-between items-center gap-5'>
                ...
                <div className='flex items-center gap-3 cursor-pointer'>
                    <Image 
                        src="https://s3-inventorymanagement11.s3.eu-central-1.amazonaws.com/profile.jpg"
                        alt='Profile'
                        width={50}
                        height={50}
                        className='rounded-full h-full object-cover'
                    />
                    <span className='font-semibold'>NikoLess</span>
                </div>
            </div>
            <Link href="/settings">
                <Settings className='cursor-pointer to-gray-500' size={24} />
            </Link>
        </div>
    </div>
  )
